...
const sustainability = [
  ...
  { emoji: "🥡", title: "Too Good To Go", body: "Cutting food waste with surprise bags." },
...
function AboutPage() {
  return (
    <div className="min-h-screen overflow-x-hidden">
      ...
      <section className="border-b-4 border-ink bg-secondary">
        <div className="mx-auto grid max-w-6xl items-center gap-10 px-4 py-16 md:grid-cols-2 md:py-24">
          <div>
            <Reveal>
              <span className="inline-block rounded-full border-2 border-ink bg-card px-3 py-1 text-xs font-bold uppercase shadow-chunky">Our story</span>
            </Reveal>
            <Reveal delay={100}>
              <h1 className="mt-5 font-display text-6xl leading-[0.9] md:text-7xl">
                Four mates. <span className="block text-primary">One mission.</span>
                <span className="block bg-accent px-2 border-2 border-ink -rotate-2 inline-block mt-2">Loaded fries.</span>
              </h1>
            </Reveal>
            <Reveal delay={200}>
      ...
      <section className="mx-auto max-w-6xl px-4 py-20">
        <Reveal>
          <h2 className="font-display text-5xl md:text-6xl">Meet the <span className="bg-accent px-2 border-2 border-ink inline-block -rotate-1">crew</span></h2>
        </Reveal>
        <div className="mt-10 grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
          {founders.map((f, i) => (
            <Reveal key={f.name} delay={i * 100}>
              <div className="rounded-3xl border-4 border-ink bg-card p-6 shadow-chunky-lg text-center">
      ...
      <section className="border-y-4 border-ink bg-primary text-primary-foreground">
        <div className="mx-auto max-w-6xl px-4 py-20">
          <Reveal>
            <span className="inline-block rounded-full border-2 border-ink bg-card px-3 py-1 text-xs font-bold uppercase text-foreground shadow-chunky">Planet first</span>
          </Reveal>
          <Reveal delay={100}>
          ...
          <Reveal delay={300}>
            <div className="mt-12 flex flex-wrap gap-3">
              <Link to="/find-us" className="rounded-full border-2 border-ink bg-card px-6 py-3 font-bold text-foreground shadow-chunky-lg transition-transform hover:-translate-y-1">
                Come visit →
              </Link>
              <Link to="/toppings" className="rounded-full border-2 border-ink bg-secondary px-6 py-3 font-bold text-foreground shadow-chunky-lg transition-transform hover:-translate-y-1">
                See the toppings
              </Link>
            </div>
          </Reveal>
