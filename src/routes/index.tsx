    ...
    <section id="planet" className="mx-auto max-w-6xl px-4 py-20">
      <div className="flex flex-col items-start gap-4 md:flex-row md:items-end md:justify-between">
        <div>
          ...
          <h2 className="mt-4 font-display text-5xl md:text-6xl max-w-2xl">Fries today. <span className="text-accent-foreground bg-accent px-2 border-2 border-ink whitespace-nowrap inline-block">Planet tomorrow.</span></h2>
        </div>
